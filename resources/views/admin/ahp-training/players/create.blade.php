...
<div style="margin-bottom:24px;">
    <h1 class="page-title">Tambah Pemain Baru</h1>
</div>

<form action="{{ route('admin.ahp.players.store') }}" method="POST" enctype="multipart/form-data">
@csrf
    ...
    <div style="display:flex;flex-direction:column;gap:16px;">
        ...
        <div class="admin-card" style="border-radius:0;">
            ...
            <div class="admin-card-body" style="text-align:center;">
                <div id="photo-preview" style="width:120px;height:140px;margin:0 auto 16px;border:2px dashed #E0E0E0;display:flex;align-items:center;justify-content:center;overflow:hidden;background:#F9F9F9;">
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#BDBDBD" stroke-width="1.5"><rect x="3" y="3" width="18" height="18"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
                </div>
                <label for="photo" class="btn-outline" style="font-size:12px;cursor:pointer;display:inline-block;">Pilih Foto</label>
        ...
        <div class="admin-card" style="border-radius:0;">
            ...
            <div class="admin-card-body" style="text-align:center;">
                <div id="og-preview" style="width:100%;height:80px;margin:0 auto 12px;border:2px dashed #E0E0E0;display:flex;align-items:center;justify-content:center;overflow:hidden;background:#F9F9F9;">
                ...
                <label for="og_image" class="btn-outline" style="font-size:12px;cursor:pointer;display:inline-block;">Pilih OG</label>
        ...
        <div class="admin-card-body" style="display:flex;flex-direction:column;gap:18px;">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                <div class="form-group" style="margin:0;">
                    ...
                    <input type="text" id="no_reg" name="no_reg" class="form-input" value="{{ old('no_reg') }}" placeholder="AHP-03" required style="font-family:monospace;">
                    <p class="hint">Format: AHP-XX</p>
            ...
            <div class="form-group" style="margin:0;">
                ...
                <input type="text" id="name" name="name" class="form-input" value="{{ old('name') }}" required style="text-transform:uppercase;" placeholder="NAMA PEMAIN">
...
<div style="display:flex;gap:10px;margin-top:20px;">
    <button type="submit" class="btn-silver">Simpan Pemain</button>
