...
ssh -p 65002 u664715641@46.202.186.86 "cd ~/domains/coachagam.hvmdigital.id/public_html && git pull origin main && /opt/alt/php83/usr/bin/php artisan migrate --force && /opt/alt/php83/usr/bin/php artisan route:clear && /opt/alt/php83/usr/bin/php artisan view:clear && /opt/alt/php83/usr/bin/php artisan cache:clear && echo '[OK] SERVER UPDATED'"
